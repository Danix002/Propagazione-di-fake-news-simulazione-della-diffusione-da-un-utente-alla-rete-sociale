...
choose_test = sam.get_choosed_test()

if (choose_test in range(1, 6)) and (cities_flag == 'Si' or cities_flag == 'No'):
    ccmv.create_complete_multiple_choroplet_view(index_iteration=int(iteration), test=choose_test, cities_flag = str(cities_flag))
else:
